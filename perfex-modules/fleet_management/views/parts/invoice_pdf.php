...
$inv_no    = $order->invoice_no ?: ('FACT-' . $order->id);
$inv_date  = $order->received_date ?: ($order->order_date ?: date('Y-m-d'));
?>
<table style="width:100%; font-size:11px;">
    <tr>
        <td style="width:55%; vertical-align:top;">
            <?php if ($has_logo) : ?><img src="<?php echo $logo_path; ?>" style="height:46px;"><br><br><?php endif; ?>
            <span style="font-size:9px; color:#999;"><?php echo _l('fleet_invoice_generated_by'); ?> <?php echo html_escape(get_option('invoice_company_name')); ?></span>
        </td>
        <td style="width:45%; vertical-align:top; text-align:right;">
            <span style="font-size:17px; font-weight:bold; color:#000000;"><?php echo _l('fleet_supplier_invoice'); ?></span><br>
            <span style="color:#777777;">N° <?php echo html_escape($inv_no); ?></span><br>
            <span style="color:#777777;"><?php echo _l('fleet_date'); ?>: <?php echo _d($inv_date); ?></span><br>
            <span style="color:#777777;"><?php echo _l('fleet_order'); ?>: PO-<?php echo $order->id; ?></span>
        </td>
    </tr>
</table>
...
<table style="width:100%; font-size:11px;">
    <tr>
        ...
        <td style="width:50%; vertical-align:top;">
            <strong><?php echo _l('fleet_invoice_billed_to'); ?></strong><br>
